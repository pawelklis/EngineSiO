...
Public Class mySQLcore
    ...
    Public Shared Function DB_Main() As mySQLcore
        Return New mySQLcore("localhost", "dbsio", "mayday1")
    End Function




    Public Shared Sub KillSleepConnections(m As mySQLcore, timeout As Integer)
        Try
            Dim dt As DataTable = m.FillDatatable("show processlist;")
            Dim a As Integer = 0
            For i = 0 To dt.Rows.Count - 1
                If dt.Rows(i)("Command").ToString.ToLower = "sleep" Then
                    Dim ti As Integer = dt.Rows(i)("time")
                    If ti > timeout Then
    ...
    Public Sub New(server As String, database As String, password As String, Optional SecondServer As String = Nothing, Optional UseCompression As Boolean = True, Optional CharacterSet As String = "utf8", Optional user As String = "root", Optional port As Integer = 3306, Optional ConnectionTimeout As Integer = 28800, Optional ConvertZeroDate As Boolean = True)
    ...
    Public Function toDict(ob As Object) As Dictionary(Of String, Object)
        ...
        For Each p In info
            dict.Add(p.Name, p.GetValue(ob, Nothing))
        Next
        Return dict
    End Function
#Region "Commands"
    ...
    Public Function InsertList(TableName As String, idColumn As String, ListOb As List(Of Object), Optional BezID As Boolean = True) As Boolean
        ...
        Try
            ...
            For Each ob In ListOb
                ...
                Next
                Try
                    If sended = False Then com.ExecuteNonQuery()
                Catch ex As Exception
...
#End Region
    ...
    Public Function InsertUpdateDuplicateKey(tablename As String, columnid As String, ob As Object) As String
        Dim sb As New StringBuilder
        ...
        Me.ExecuteNonQuery(sb.ToString)
    ...
    Private Function getinsertduplicateString(ob As Object) As String
        Dim props As PropertyInfo() = ob.GetType.GetProperties
        ...
        For Each p In props
            sb.Append("'")
            sb.Append(p.GetValue(ob, Nothing))
            sb.Append("'")
            sb.Append(",")
        Next
